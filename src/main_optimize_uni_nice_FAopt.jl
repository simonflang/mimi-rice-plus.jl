...
if optimization == "Yes"
    ...
    nice_objective_FAopt, m, rice_params  = construct_nice_objective_FAopt()
    println("nice_objective_FAopt_main: ", nice_objective_FAopt)
    ...
    results = optimize_nice_FAopt(nice_objective_FAopt, m, opt_algorithm, n_objective, backstop_opt_values, stop_time, tolerance, theta2, rice_params[:pbacktime]) # theta2 = 2.8
