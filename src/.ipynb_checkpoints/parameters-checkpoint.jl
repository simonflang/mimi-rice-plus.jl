...
function getrice2010parameters(filename)
    ...
    p[:tatm1900] = getparam_single(f, "B160:B160", regions) # Regional Temperature in 1900
    ...
    p[:d1] = 1.27183/100 # BHM Economic Impact Function intercept
    p[:d2] = -4.871/10000 # BHM Economic Impact Function quadratic term
